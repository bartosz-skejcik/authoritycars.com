...
CREATE OR REPLACE FUNCTION "public"."is_admin"() RETURNS boolean
    ...
    AS $$
BEGIN
  -- This is just an example. Customize this to your needs.
  -- Perhaps check if the user is in an admin group or has admin flag
  RETURN EXISTS (
...
CREATE OR REPLACE FUNCTION "public"."log_avatar_changes"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  user_id UUID := public.get_auth_user_id();
...
ALTER FUNCTION "public"."log_avatar_changes"() OWNER TO "postgres";
...
CREATE POLICY "Admins can manage profiles" ON "public"."profiles" TO "authenticated" USING ("public"."is_admin"());
...
CREATE POLICY "Anyone can view audit logs" ON "public"."audit_logs" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Anyone can view statuses" ON "public"."statuses" FOR SELECT USING (true);



CREATE POLICY "Anyone can view submission tags" ON "public"."submission_tags" FOR SELECT USING (true);
...
CREATE POLICY "Authenticated users can delete submission tags" ON "public"."submission_tags" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can delete submissions" ON "public"."submissions" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can insert submission tags" ON "public"."submission_tags" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can manage profiles" ON "public"."profiles" TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can update submissions" ON "public"."submissions" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Only admins can delete submissions" ON "public"."submissions" FOR DELETE TO "authenticated" USING ("public"."is_admin"());



CREATE POLICY "Only authenticated users can delete statuses" ON "public"."statuses" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Only authenticated users can delete tags" ON "public"."tags" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Only authenticated users can insert contact info" ON "public"."contact_info" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Only authenticated users can insert statuses" ON "public"."statuses" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Only authenticated users can insert tags" ON "public"."tags" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Only authenticated users can update contact info" ON "public"."contact_info" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Only authenticated users can update statuses" ON "public"."statuses" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Only authenticated users can update tags" ON "public"."tags" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Only authenticated users can view audit logs" ON "public"."audit_logs" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON FUNCTION "public"."log_avatar_changes"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_avatar_changes"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_avatar_changes"() TO "service_role";
...
GRANT SELECT ON TABLE "public"."referrers" TO PUBLIC;
